...
public class Number_guess_game {
    ...
    public static void playNumberGuessingGame(){
        ...
        System.out.println("Attempt 1 -> 200, Attempt 2 -> 175, Attempt 3 -> 150, Attempt 4 -> 125, Attempt 5 -> 100, Attempt 6 -> 75, Attempt 7 -> 50, Attempt 8 -> 25");
        ...
        if(answer.equals("Yes") || answer.equals("yes")){
            ...
            if(!isGuessCorrect){
                System.out.println("You have used all 8 attempts. The secret number was: " + secretNumber);
            }
        }
